...
export default function KioskPage() {
    ...
    useEffect(() => {
        ...
        // Don't start loop if we are busy taking a photo!
        if (status === 'processing' || status === 'countdown') { setStreamStatus('offline'); return; }
        ...
        const loop = async () => {
            ...
            try {
                ...
                const imgRes = await fetch(localUrl); const blob = await imgRes.blob();
